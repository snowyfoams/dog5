...
RUN -- after tau_calib_hw has passed, before any force law exists
    ...
    python3 selftest/test_torque_runners.py       # offline gates first
    python3 selftest/test_stance_law.py           # the stability prediction

    # ROBOT SUPPORTED, feet on the floor, TETHERED.  Climb the gain:
    sudo HOME=$HOME chrt -f 50 python3 torque_primitives/torque_hold_hw.py --kp 5  --kd 0.6
    sudo HOME=$HOME chrt -f 50 python3 torque_primitives/torque_hold_hw.py --kp 15 --kd 0.6
    sudo HOME=$HOME chrt -f 50 python3 torque_primitives/torque_hold_hw.py --kp 30 --kd 0.6
    ...
    sudo HOME=$HOME chrt -f 50 python3 torque_primitives/torque_hold_hw.py \
