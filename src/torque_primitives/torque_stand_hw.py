...
_POS = os.path.join(_AUG, "imu_closedloop_stand")
...
def bus_report(mb):
    ...
    if worst > 5.0:
        ...
        out.append("      python3 imu_closedloop_stand/../can_soak_hw.py  # if present")
        out.append("      sudo chrt -f 50 python3 ../../t8_lost_probe.py")
    return "\n".join(out)
