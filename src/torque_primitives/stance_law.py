...
RUN
    ...
    python3 selftest/test_stance_law.py        # 41 gates, no hardware
    ...
    python3 torque_primitives/torque_hold_hw.py  --kp 15 --kd 0.6   # impedance only
    python3 torque_primitives/torque_stand_hw.py --force-frac 0     # + q_ref
    python3 torque_primitives/torque_stand_hw.py --force-frac 1     # + force law
"""
