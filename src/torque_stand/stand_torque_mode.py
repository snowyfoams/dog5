...
RUN -- supported robot, hand on SPACE
    ...
    python3 torque_stand/stand_torque_mode.py --self-test     # offline, no hardware
    ...
    sudo HOME=$HOME chrt -f 50 python3 torque_stand/stand_torque_mode.py --tau-max 1.0
    ...
    sudo HOME=$HOME chrt -f 50 python3 torque_stand/stand_torque_mode.py --open-loop
    sudo HOME=$HOME chrt -f 50 python3 torque_stand/stand_torque_mode.py \
    ...
    sudo HOME=$HOME chrt -f 50 python3 torque_stand/stand_torque_mode.py --log live.npz
    sudo HOME=$HOME chrt -f 50 python3 torque_stand/stand_torque_mode.py \
