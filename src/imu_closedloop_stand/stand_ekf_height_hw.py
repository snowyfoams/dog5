...
Run:
    python3 stand_ekf_height_hw.py --self-test              # no hardware needed
    sudo chrt -f 50 python3 stand_ekf_height_hw.py --log h.csv --raw-log h.npz
    # open-loop A/B (should reproduce stage 1 exactly):
    sudo chrt -f 50 python3 stand_ekf_height_hw.py --height-gain 0
"""
...
#
#     python3 selftest/test_stand_ekf_height.py     # the same thing, run directly
