...
HOW TO RUN
    sudo chrt -f 50 python3 stand_ahrs_level_hw.py --level-gain 0 --level-kp 0
                                                   # A/B baseline (open loop)
    sudo chrt -f 50 python3 stand_ahrs_level_hw.py      # leveling live, PI
    # the EKF script's exact law, for the like-for-like A/B:
    sudo chrt -f 50 python3 stand_ahrs_level_hw.py --level-kp 0 --level-gain 0.25 \
                                              --level-slew 0.004
...
#
#     python3 selftest/test_stand_ahrs_level.py     # the same thing, run directly
