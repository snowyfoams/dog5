...
HOW TO RUN
    ...
    python3 lift_ekf_contact_hw.py --self-test       # offline gates, no hardware

    # 1. honest contacts -- expect zEKF and zFK to agree
    sudo chrt -f 50 python3 lift_ekf_contact_hw.py
    # 2. the A/B -- expect zEKF to walk ~5 mm off zFK
    sudo chrt -f 50 python3 lift_ekf_contact_hw.py --fake-contacts
...
#
#     python3 selftest/test_lift_ekf_contact.py     # the same thing, run directly
