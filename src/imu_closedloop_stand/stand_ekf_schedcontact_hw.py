...
HOW TO RUN
    python3 stand_ekf_schedcontact_hw.py --self-test
    sudo chrt -f 50 python3 stand_ekf_schedcontact_hw.py
    # if the rear feet audibly touch earlier/later in the ramp, adjust:
    sudo chrt -f 50 python3 stand_ekf_schedcontact_hw.py --touch-frac 0.2
"""
...
#
#     python3 selftest/test_stand_ekf_schedcontact.py     # the same thing, run directly
