#!/usr/bin/env python3
"""Shared harness and fixtures for the the August track self-tests.
...
_RUNNERS = os.path.join(os.path.dirname(_HERE), "imu_closedloop_stand")
# ^ the hardware scripts live in imu_closedloop_stand/, beside this directory
