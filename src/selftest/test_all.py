...
Run:  python3 test_all.py            # everything, ~2-4 min (table builds dominate)
      python3 test_all.py level ahrs # only the suites whose name contains these
"""
...
SUITES = [
    ("layout   repo structure and import hygiene", "test_layout.py"),
    ...
    # ---- torque track (torque_primitives/) --------------------------------
