...
REPO = dog5_paths.REPO
# Run logs are not tracked in this repository; see data/README.md for which
# files to drop in.  The hardware-log regression below skips when absent.
WALK_LOG = dog5_paths.data("crawl", "walk_0729_1748.npz")
STAND_LOG = dog5_paths.data("ekf", "stand.npz")
