...
# Locate IMU_sensor from the source root rather than via $HOME: $HOME is /root
# under sudo/chrt, which would break the import at real-time priority.
_IMU_DIR = Path(dog5_paths.SRC) / "IMU_sensor"
