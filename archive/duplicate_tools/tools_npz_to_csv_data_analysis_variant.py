...
try:
    ...
    # THIS FALLBACK IS NOT A DEGRADATION.  It is asserted equal to
    # stand_dog5_hw.JOINT_LABELS, so off the robot -- which is where this
    # folder is meant to be opened -- the column names come out identical.
    # The labels are a naming convention; only the CAN stack is hardware.
