...
## VENDORED VERBATIM from ../Code_ForCanBusTest/motor_library.py
## (copied to keep this demo self-contained / portable to the robot host)
## ===========================
...
class LKMotor:
    ...
    def ensure_running(self) -> Optional[int]:
        ...
        lists it as 0x00); only 0x10 means stopped. Some latched faults (e.g. the
        input-signal-timeout flag 0x80) may not clear via 0x9B and need a power
        cycle.
